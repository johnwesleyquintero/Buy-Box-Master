        ...
        <div className="flex-1 overflow-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
          <table className="min-w-full text-left text-sm whitespace-nowrap border-separate border-spacing-0">
            <thead className="bg-slate-50 text-slate-500">
              <tr>
                <HeaderCell label="Product" sortKey="title" />
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="relative group/image shrink-0">
                          ...
                          {/* Hover Popover */}
                          {product.imageUrl && (
                            <div className="absolute left-12 top-1/2 -translate-y-1/2 w-48 bg-white p-2 rounded-lg shadow-xl border border-slate-200 opacity-0 invisible group-hover/image:opacity-100 group-hover/image:visible transition-all z-50 pointer-events-none">
                              <img src={product.imageUrl} alt="" className="w-full h-auto rounded bg-white" />
                            </div>
                          )}
                        </div>
